...
const stories = [
  ...
  { id: 4, name: '필라테스요정', imageUrl: 'https://images.unsplash.com/photo-1549476464-37392f717541?w=100&h=100&fit=crop&crop=face' },
...
const feeds = [
  ...
  },
  {
    ...
    authorName: '헬스왕',
    location: '바디채널 서초점',
    text: '필라테스 수업 후기 🧘‍♀️ 정말 시원하네요. 코어가 단단해지는 느낌!',
    likeCount: 89,
    commentCount: 12,
    isLiked: false,
    timeAgo: '4시간 전',
