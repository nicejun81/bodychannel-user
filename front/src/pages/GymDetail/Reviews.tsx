...
const allReviews = [
  ...
  { name: '필라테스초보', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face', rating: 4, date: '2025.10.08', text: '필라테스 수업 처음 들었는데 강사님이 차근차근 알려주셔서 좋았어요.', membershipType: '바레톤 1개월' },
